...
Further details about the application is available in the project's [GitPages repository](https://ncatstranslator.github.io/SRI_Testing/) and also [Translator Developer Documentation](https://ncatstranslator.github.io/TranslatorTechnicalDocumentation/architecture/sri/testing/sri_testing/).
